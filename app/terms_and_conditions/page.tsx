export default function TermsAndConditions(){
    return(
        <div className="container min-vh-100">
            <div>
                <h1 className="p-text fw-bold display-1">Terms and Conditions</h1>
            </div>
        ...
        <p>The content, features, and functionality of our services are and will remain the exclusive property of Aurorasystems and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Aurorasystems.</p>

        <h2>5. User-Generated Content</h2>
        <p>You may post, upload, or otherwise contribute content to our services ("User Content"). You retain any rights you may have in the User Content you provide. However, by providing User Content, you grant us a worldwide, non-exclusive, royalty-free, transferable, and sublicensable right to use, reproduce, modify, distribute, and display such content in connection with our services.</p>

        <h2>6. Prohibited Activities</h2>
        <p>You agree not to engage in any of the following prohibited activities:</p>
        <ul>
            <li>Copying, distributing, or disclosing any part of our services in any medium, including without limitation by any automated or non-automated "scraping."</li>
            <li>Using any automated system, including without limitation "robots," "spiders," "offline readers," etc., to access our services in a manner that sends more request messages to our servers than a human can reasonably produce in the same period of time by using a conventional online web browser.</li>
